        ...
        <div className="main_page">
            ...
            <div className="flex-row">
                ...
                {item_selected===navibar_items[0] ? <UserInfo user_info={InfoRef.current.user_info} reqUserInfo={info_mgr.reqUserInfo} handleChangeInfo={info_mgr.reqUserInfoChange} init_state={InfoRef.current.init_state[navibar_items[0]]} />:
                    item_selected===navibar_items[1] ? <Outfits outfit_list={InfoRef.current.outfit_list} reqOutfitList={info_mgr.reqOutfitList} init_state={InfoRef.current.init_state[navibar_items[1]]} reqClothes={info_mgr.reqClothes} clothes={InfoRef.current.clothes_lists} reqAddOutfit={info_mgr.reqAddOutfit}/>:
                        item_selected===navibar_items[2] ? <Articles article_list={InfoRef.current.article_list} reqArticles={info_mgr.reqArticles} init_state={InfoRef.current.init_state[navibar_items[2]]} uid={InfoRef.current.user_info.uid} socket={socket} reqAddArticle={info_mgr.reqAddArticle}/>:
                            item_selected===navibar_items[3] ? <Clothes clothes_lists={InfoRef.current.clothes_lists} reqClothes={info_mgr.reqClothes} init_state={InfoRef.current.init_state[navibar_items[3]]} socket={socket} reqAddClothes={info_mgr.reqAddClothes}/>:
